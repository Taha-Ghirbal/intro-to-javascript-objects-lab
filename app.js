...
*/
game.difficulty = ["Medium", "Hard", "Easy"];
...
*/
const pokemon1 = pokemon.find(p => p.number === 10);
const pokemon2 = pokemon.find(p => p.number === 25);
const pokemon3 = pokemon.find(p => p.number === 7);
...
const newPokemon = pokemon.find(p => p.number === 16); // Pidgey
...
const anotherPokemon = pokemon.find(p => p.number === 19); // Rattata
...
console.log(`Number of Pokémon in party: ${numberOfPokemon}`);
